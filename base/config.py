...
def base_config(cfg_dict):
    ...
    # Dataset setting
    parser.add_argument('--trset', default='PFOS_val', help='Set the traing set') # OSIE-CFPS
    parser.add_argument('--vals', default='PFOS_val', help='Set the testing sets') # SOD,PASCAL-S,ECSSD,DUTS-TE,HKU-IS,DUT-OMRON
